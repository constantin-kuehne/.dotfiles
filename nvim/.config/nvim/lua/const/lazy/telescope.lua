return {
    ...
    config = function()
        ...
        vim.keymap.set("n", "<leader>fo", builtin.live_grep, { desc = "[] Live grep" })
        ...
        vim.keymap.set("n", "<leader>fc", "<cmd>Telescope neoclip<cr>", { desc = "[] Clipboard" })
        ...
        vim.keymap.set("n", "<leader>fl", live_multigrep, { desc = "[] Live multi grep" })
    end
}
